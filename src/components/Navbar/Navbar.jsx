...
const Navbar = () => {
  ...
  return (
    <div className='spaceX__navbar'>
      <div className='spaceX__navbar-logo' onClick={()=>{navigate('/')}}>
      ...
      <div className='spaceX__navbar-options'>
        <Options />
      </div>
      <div className='spaceX__navbar-options-dropdown'>
        {
          menu
            ? <RiCloseFill color={'white'} size={30} onClick={(e) => { toggleMenu(!menu) }} />
            : <RiMenu3Line color={"white"} size={30} onClick={(e) => { toggleMenu(!menu) }} />
        }
        {
          menu && (
            <div className='menu'>
